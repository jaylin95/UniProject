...
public class MyProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Summoner summoner = api.getSummonerByName(Platform.EUW, summoner2);
        ...
        ListView sumSearchResult = findViewById(R.id.myProfileData);
